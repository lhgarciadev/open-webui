...
app.state.config.ENABLE_PRESENTATIONS = ENABLE_PRESENTATIONS
...
app.state.config.DEFAULT_FUNCTION_CALLING_MODE = DEFAULT_FUNCTION_CALLING_MODE
        ...
        metadata = {
            ...
            "params": {
                ...
                "function_calling": (
                    ...
                    if form_data.get("params", {}).get("function_calling")
                    in ["native", "default"]
                    else (
                        model_info_params.get("function_calling")
                        if model_info_params.get("function_calling")
                        in ["native", "default"]
                        else None
                    )
                ),
            ...
            **(
                {
                    ...
                    "enable_presentations": app.state.config.ENABLE_PRESENTATIONS,
