...
- **Compliance**:
  ...
  - "Powered by Open WebUI" attribution _only if required/allowed by license for backend credit_, otherwise removed from visible UI to strictly follow Clause 4 (which prohibits using the branding). _Correction_: Clause 4 prohibits using branding to _distinguish_ the software. Standard copyright notices in source code must remain (Clause 1).
