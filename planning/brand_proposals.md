# Propuestas de Nombre de Marca

> **Fecha**: 2026-02-12
> **Contexto**: Plataforma de IA empresarial para PyMEs colombianas (< 50 usuarios)
> **SELECCIONADO**: Cognitia (2026-02-12)
...
```
Nombre completo: NeuralCore AI
Nombre corto:    NeuralCore
Dominio:         neuralcore.ai / neuralcore.co
```
...
```
Nombre completo: Synapse Hub
Nombre corto:    Synapse
Dominio:         synapsehub.ai / synapse.co
```
...
Dominio:         cognitia.ai / cognitia.co
```
...
```
Nombre completo: Axion AI
Nombre corto:    Axion
Dominio:         axion.ai / axionai.co
```
...
```
Nombre completo: Lumina AI
Nombre corto:    Lumina
Dominio:         lumina.ai / luminaai.co
```
...
**Top 2 para mercado colombiano**:

1. **Cognitia** - Mejor sonoridad en espanol, unico, profesional
2. **NeuralCore AI** - Balance entre tecnico y accesible, fuerte branding

**Para expansion internacional**:

1. **Axion AI** - Corto, memorable, funciona globalmente
2. **NeuralCore AI** - Tecnico pero universal
