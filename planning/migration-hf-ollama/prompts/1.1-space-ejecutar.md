# Fase 1.1 - Ejecutar Creación de HF Space
...
- Puerto 7860 es el estándar de HF Spaces
- ZeroGPU se configura después del build inicial
...
# Configuración para HF Spaces + ZeroGPU
...
# Phi3 - Rápido, bajo consumo de cuota
...
# CodeLlama 7B - Para programación
...
7. VERIFICAR BUILD:
   ...
   # Ver logs en la pestaña "Logs" del Space
...
├── start.sh # Script de inicio + descarga modelos
...
# Errores comunes:
# - Puerto incorrecto → Verificar EXPOSE 7860
# - Script no ejecutable → chmod +x start.sh
# - Sintaxis YAML → Verificar README.md
```
