...
2. AGREGAR MODELOS ADICIONALES (Opcional):
   ...
   # Agregar al final de la sección de modelos:
   cat >> start.sh << 'EOF'

# Modelos adicionales (Fase 5 - Optimización)
...
# Llama 3.2 3B - Ultra rápido para respuestas simples
...
6. CONSIDERAR PRO (si cuota insuficiente):
   ...
   # PRO = $9/mes → 8x más cuota + prioridad
...
7. CONFIGURAR ALIASES EN COGNITIA (Opcional):
   ...
   # - "Chat Rápido" → phi3
   # - "Chat Inteligente" → qwen2.5:7b
   # - "Programación" → codellama:7b
...
| Modelo | Tamaño | Cuota | Recomendación |
|--------|--------|-------|---------------|
| gemma2:9b | 5.4GB | Media | ⭐ Razonamiento |
| llama3.2:3b | 2GB | Baja | ⭐⭐ Velocidad |
| mistral:7b | 4.1GB | Media | ⭐ Versatilidad |
